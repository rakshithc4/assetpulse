...
// ShaderBackground — one WebGL canvas that fills its parent, zero
// dependencies. Drop it behind content with
// <div className="relative"><ShaderBackground className="absolute inset-0" />…
// GLSL/animation-loop plumbing is a direct port of a proven "mesh drift"
// recipe; only UNIFORMS.colors is AssetPulse-specific (warm amber/copper
// drift over the control-room surface.base, keeping the mining-industrial
// identity instead of a generic blue-dashboard gradient).
...
// Warm amber/copper drift, tuned to sit behind design/tokens.json's
// surface.base (#0a0908) — mining-industrial identity instead of a
// generic blue-dashboard gradient.
const UNIFORMS = {
  colors: [
    [0.0392, 0.0353, 0.0314], // #0a0908 (surface.base)
    [0.1412, 0.0706, 0.0275], // deep burnt amber
    [0.2275, 0.1725, 0.1216], // muted copper-slate
    [0.2902, 0.2196, 0.149], // warm graphite-amber highlight
    [0.2902, 0.2196, 0.149],
    [0.2902, 0.2196, 0.149],
    [0.2902, 0.2196, 0.149],
    [0.2902, 0.2196, 0.149],
